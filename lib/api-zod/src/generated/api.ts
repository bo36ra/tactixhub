...
export const ListPlayersResponseItem = zod.object({
  ...
  "position": zod.enum(['goalkeeper', 'center_back', 'full_back', 'wing_back', 'defender', 'defensive_midfielder', 'attacking_midfielder', 'midfielder', 'winger', 'second_striker', 'forward']),
...
export const UpdatePlayerBody = zod.object({
  ...
  "position": zod.enum(['goalkeeper', 'center_back', 'full_back', 'wing_back', 'defender', 'defensive_midfielder', 'attacking_midfielder', 'midfielder', 'winger', 'second_striker', 'forward']).optional(),
  "age": zod.number().optional(),
  "nationality": zod.string().optional(),
