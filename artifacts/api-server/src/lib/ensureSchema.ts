...
const STATEMENTS = [
  ...
  `ALTER TABLE "trainings" ADD COLUMN IF NOT EXISTS "place" text`,
  `ALTER TABLE "trainings" ADD COLUMN IF NOT EXISTS "players_total" integer`,
  `ALTER TABLE "trainings" ADD COLUMN IF NOT EXISTS "players_unavailable" integer`,
  `ALTER TABLE "trainings" ADD COLUMN IF NOT EXISTS "material" text`,
  `ALTER TABLE "trainings" ADD COLUMN IF NOT EXISTS "main_objective_offense" text`,
  `ALTER TABLE "trainings" ADD COLUMN IF NOT EXISTS "main_objective_defense" text`,
  `ALTER TABLE "trainings" ADD COLUMN IF NOT EXISTS "complementary_objective" text`,
  ...
  `CREATE TABLE IF NOT EXISTS "exercise_library" (
    ...
    "objective_offense" text,
    "objective_defense" text,
    "space" text,
    "players_format" text,
    "minutes" integer,
    "explanation" text,
  ...
  `ALTER TABLE "teams" ADD COLUMN IF NOT EXISTS "seeded_exercise_keys" text`,
  ...
  `CREATE TABLE IF NOT EXISTS "match_highlight_clips" (
    "id" serial PRIMARY KEY,
    "match_id" integer NOT NULL REFERENCES "matches"("id") ON DELETE CASCADE,
    "title" text NOT NULL,
    "category" text,
